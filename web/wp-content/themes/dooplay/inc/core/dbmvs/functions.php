...
function dbmovies_get_poster_for_kg($post_id = '', $thumb_size = 'dt_poster_a', $post_meta = 'dt_poster', $size = 'w185'){
    $thumb_id = get_post_thumbnail_id($post_id);
    $thumb_url = wp_get_attachment_image_src($thumb_id, $thumb_size,false);
    $poster = isset($thumb_url[0]) ? $thumb_url[0] : false;
    return esc_url($poster);
}
