...
//        wp_enqueue_style('bootstrap-css', DOO_URI.'/assets/css/bootstrap'.doo_devmode().'.css', array(), DOO_VERSION);
...
//        wp_enqueue_script('bootstrap-js',DOO_URI.'/assets/js/lib/bootstrap.js', array('jquery'), DOO_VERSION, false);
