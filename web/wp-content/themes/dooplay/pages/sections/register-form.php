<form method="POST" id="dooplay_sign_up" class="register_form">
	<fieldset>
		...
		<input type="text" placeholder="ZeWang" id="username" name="username" value="<?php echo isset($_POST['username']) ? $_POST['username'] : false; ?>" required />
	</fieldset>
	<fieldset>
		<label for="email"><?php _d('E-mail address'); ?></label>
		<input type="text" placeholder="wangzeztony@email.com" id="email" name="email" value="<?php echo isset($_POST['email']) ? $_POST['email'] : false; ?>" required />
	</fieldset>
	<fieldset>
	...
	<fieldset class="min fix">
		...
		<input type="text" placeholder="Ze" id="firstname" name="firstname" value="<?php echo isset($_POST['firstname']) ? $_POST['firstname'] : false; ?>" required />
	</fieldset>
	<fieldset class="min">
		<label for="dt_last_name"><?php _d('Last name'); ?></label>
		<input type="text" placeholder="Wang" id="lastname" name="lastname" value="<?php echo isset($_POST['lastname']) ? $_POST['lastname'] : false; ?>" required />
	</fieldset>
	...
	<fieldset>
		...
		<span><a href="<?php echo doo_compose_pagelink('pageaccount'); ?>?action=log-in"><?php _d('Login here'); ?></a></span>
	</fieldset>
