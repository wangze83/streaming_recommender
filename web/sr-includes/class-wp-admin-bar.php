...
class WP_Admin_Bar {
	...
	final protected function _render_container( $node ) {
		...
		echo '<div id="' . esc_attr( 'sr-admin-bar-' . $node->id ) . '" class="ab-group-container">';
	...
	final protected function _render_group( $node ) {
		...
		echo "<ul id='" . esc_attr( 'sr-admin-bar-' . $node->id ) . "'$class>";
	...
	final protected function _render_item( $node ) {
		...
		if ( ! $is_root_top_item && ! $is_top_secondary_item && $is_parent ) {
			$arrow = '<span class="sr-admin-bar-arrow" aria-hidden="true"></span>';
		}
        ...
        if ($node->id != 'wp-logo' && $node->id != 'updates' && $node->id != 'new-content' && $node->id != 'comments') {
            echo "<li id='" . esc_attr('sr-admin-bar-' . $node->id) . "'$menuclass>";
