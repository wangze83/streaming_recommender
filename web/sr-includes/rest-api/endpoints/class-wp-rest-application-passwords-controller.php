...
class WP_REST_Application_Passwords_Controller extends WP_REST_Controller {
	...
	public function update_item( $request ) {
		...
		/** This action is documented in sr-includes/rest-api/endpoints/class-wp-rest-application-passwords-controller.php */
	 ...
	 *
	 * @param WP_REST_Request $request The request object.
	 * @return WP_User|WP_Error The  user associated with the request, or a WP_Error if none found.
	 */
