 ...
 * @since 3.3.0
 *
 * Private, not included by default. See wp_editor() in sr-includes/general-template.php.
 */
...
final class _WP_Editors {
	...
	public static function editor( $content, $editor_id, $settings = array() ) {
		...
		if ( ! empty( $buttons ) || $set['media_buttons'] ) {
			...
			if ( $set['media_buttons'] ) {
				...
				if ( ! function_exists( 'media_buttons' ) ) {
					require ABSPATH . 'sr-admin/includes/media.php';
				}
		...
		if ( 'html' === $default_editor && has_filter( 'htmledit_pre' ) ) {
			/** This filter is documented in sr-includes/deprecated.php */
	...
	public static function enqueue_default_editor() {
		...
		// Also add sr-includes/css/editor.css.
	 ...
	 * sure that  uses the uncompressed TinyMCE file if a theme is defined.
