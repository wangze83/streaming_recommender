...
function get_oembed_response_data_for_url( $url, $args ) {
	...
	/** This filter is documented in sr-includes/class-wp-oembed-controller.php */
			...
			<div class="wp-embed-share-dialog-text">
				<ul class="wp-embed-share-tabs" role="tablist">
					<li class="wp-embed-share-tab-button wp-embed-share-tab-button-wordpress" role="presentation">
						<button type="button" role="tab" aria-controls="<?php echo $share_tab_wordpress_id; ?>" aria-selected="true" tabindex="0"><?php esc_html_e( ' Embed' ); ?></button>
					</li>
