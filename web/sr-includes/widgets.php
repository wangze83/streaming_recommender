 ...
 *
 * @link /documentation/article/manage-wordpress-widgets/
...
function dynamic_sidebar( $index = 1 ) {
	...
	if ( empty( $wp_registered_sidebars[ $index ] ) || empty( $sidebars_widgets[ $index ] ) || ! is_array( $sidebars_widgets[ $index ] ) ) {
		/** This action is documented in sr-includes/widget.php */
		do_action( 'dynamic_sidebar_before', $index, false );
		/** This action is documented in sr-includes/widget.php */
		do_action( 'dynamic_sidebar_after', $index, false );
		/** This filter is documented in sr-includes/widget.php */
...
function the_widget( $widget, $instance = array(), $args = array() ) {
	...
	/** This filter is documented in sr-includes/class-wp-widget.php */
...
function wp_render_widget( $widget_id, $sidebar_id ) {
	...
	/** This filter is documented in sr-includes/widgets.php */
	$params = apply_filters( 'dynamic_sidebar_params', $params );
