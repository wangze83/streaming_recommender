...
/**
 * Retrieves all of the  supported post statuses.
 *
...
/**
 * Retrieves all of the  support page statuses.
 *
...
function wp_get_attachment_url( $attachment_id = 0 ) {
	...
	if ( is_ssl() && ! is_admin() && 'sr-login.php' !== $pagenow ) {
 ...
 *
 * @since 5.0.0
 * @since 6.1.0 Moved to sr-includes from sr-admin.
 *
 ...
 *
 * @link https://github.com//gutenberg/pull/51144
 */
