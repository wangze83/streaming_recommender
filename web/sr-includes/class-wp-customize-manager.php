...
final class WP_Customize_Manager {
	...
	public function validate_setting_values( $setting_values, $options = array() ) {
		...
		foreach ( $setting_values as $setting_id => $unsanitized_value ) {
			...
			if ( ! is_wp_error( $validity ) ) {
				/** This filter is documented in sr-includes/class-wp-customize-setting.php */
	...
	public function get_return_url() {
		...
		$excluded_referer_basenames = array( 'customize.php', 'sr-login.php' );
	...
	public function register_controls() {
		...
		$section_description .= sprintf(
			...
			esc_url( __( '/documentation/article/css/' ) ),
	...
	public function handle_load_themes_request() {
		...
		if ( 'installed' === $theme_action ) {
			...
			// This list matches the allowed tags in sr-admin/includes/theme-install.php.
