...
function get_search_comments_feed_link( $search_query = '', $feed = '' ) {
	...
	/** This filter is documented in sr-includes/link-template.php */
 ...
 * (e.g. sr-blog-header.php or the sr-admin/ folder) are accessible.
 *
...
function get_admin_url( $blog_id = null, $path = '', $scheme = 'admin' ) {
	$url = get_site_url( $blog_id, 'sr-admin/', $scheme );
...
function includes_url( $path = '', $scheme = null ) {
	 ...
	 * @param string      $path   Path relative to the URL to the sr-includes directory. Blank string
...
function network_admin_url( $path = '', $scheme = 'admin' ) {
	...
	$url = network_site_url( 'sr-admin/network/', $scheme );
...
function user_admin_url( $path = '', $scheme = 'admin' ) {
	$url = network_site_url( 'sr-admin/user/', $scheme );
