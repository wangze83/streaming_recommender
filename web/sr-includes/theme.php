...
function switch_theme( $stylesheet ) {
	...
	if ( is_admin() && false === get_option( 'theme_mods_' . $stylesheet ) ) {
		 ...
		 * the Customizer when accessing sr-admin/widgets.php.
		 */
		if ( 'wp_ajax_customize_save' === current_action() ) {
...
function get_theme_mod( $name, $default_value = false ) {
	...
	/** This filter is documented in sr-includes/theme.php */
...
function _custom_header_background_just_in_time() {
	...
	if ( current_theme_supports( 'custom-header' ) ) {
		...
		if ( is_admin() ) {
			require_once ABSPATH . 'sr-admin/includes/class-custom-image-header.php';
	...
	if ( current_theme_supports( 'custom-background' ) ) {
		...
		if ( is_admin() ) {
			require_once ABSPATH . 'sr-admin/includes/class-custom-background.php';
...
function current_theme_supports( $feature, ...$args ) {
	...
	if ( ! $args ) {
		/** This filter is documented in sr-includes/theme.php */
		return apply_filters( "current_theme_supports-{$feature}", true, $args, $_wp_theme_features[ $feature ] ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	}
...
function check_theme_switched() {
	...
	if ( $stylesheet ) {
		...
		if ( $old_theme->exists() ) {
			...
			/** This action is documented in sr-includes/theme.php */
...
function _wp_customize_publish_changeset( $new_status, $old_status, $changeset_post ) {
	...
	if ( ! did_action( 'customize_register' ) ) {
		...
		/** This filter is documented in sr-includes/class-wp-customize-manager.php */
