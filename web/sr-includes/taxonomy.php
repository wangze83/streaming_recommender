 ...
 *
 * This function fires twice: in sr-settings.php before plugins are loaded (for
...
function wp_insert_term( $term, $taxonomy, $args = array() ) {
	...
	if ( empty( $slug ) ) {
		...
		/** This action is documented in sr-includes/taxonomy.php */
...
function wp_unique_term_slug( $slug, $term ) {
	...
	if ( apply_filters( 'wp_unique_term_slug_is_bad_slug', $needs_suffix, $slug, $term ) ) {
		...
		if ( $wpdb->get_var( $query ) ) { // phpcs:ignore .DB.PreparedSQL.NotPrepared
			$num = 2;
			do {
				$alt_slug = $slug . "-$num";
				$num++;
...
function wp_update_term( $term_id, $taxonomy, $args = array() ) {
	...
	/** This filter is documented in sr-includes/taxonomy.php */
