...
!function() {
/**
 * @output sr-includes/js/media-models.js
 */
...
_.extend( media, /** @lends wp.media */{
	 ...
	 *
	 * See wp.template() in `sr-includes/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.post() in `sr-includes/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.send() in `sr-includes/js/wp-util.js`.
	 *
