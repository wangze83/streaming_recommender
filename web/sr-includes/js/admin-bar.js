/**
 * @output sr-includes/js/admin-bar.js
 */
/**
...
( function( document, window, navigator ) {
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		adminBarLogout = document.getElementById( 'sr-admin-bar-logout' );
		adminBarSearchForm = document.getElementById( 'adminbarsearch' );
		shortlink = document.getElementById( 'sr-admin-bar-get-shortlink' );
	...
	function scrollToTop( event ) {
		...
		if (
			...
			event.target.id !== 'sr-admin-bar-top-secondary'
		) {
			return;
		}
