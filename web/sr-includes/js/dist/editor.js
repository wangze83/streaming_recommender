 ...
 *
 * Keys are crucially prefixed with 'wp-autosave-' so that sr-login.php's
 * `loggedout` handler can clear sessionStorage of any user-private content.
 *
 * @see https://github.com//wordpress-develop/blob/6dad32d2aed47e6c0cf2aee8410645f6d7aba6bd/src/sr-login.php#L103
 *
...
function PostExcerpt({
  ...
  return (0,external_wp_element_namespaceObject.createElement)("div", {
    ...
    href: (0,external_wp_i18n_namespaceObject.__)('/documentation/article/page-post-settings-sidebar/#excerpt')
...
const {
  lock,
  unlock
} = (0,external_wp_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next  release.', '@wordpress/editor');
...
function PostURL({
  ...
  return (0,external_wp_element_namespaceObject.createElement)("div", {
    ...
    help: (0,external_wp_element_namespaceObject.createElement)(external_wp_element_namespaceObject.Fragment, null, (0,external_wp_i18n_namespaceObject.__)('The last part of the URL.'), ' ', (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.ExternalLink, {
      href: (0,external_wp_i18n_namespaceObject.__)('/documentation/article/page-post-settings-sidebar/#permalink')
