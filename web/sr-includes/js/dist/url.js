 ...
 * const protocol2 = getProtocol( '' ); // 'https:'
 * ```
 *
 ...
 * @example
 * ```js
 * const authority1 = getAuthority( '/help/' ); // 'wordpress.org'
 ...
 * const path2 = getPath( '/help/faq/' ); // 'help/faq'
 * ```
 *
 ...
 * const pathAndQueryString2 = getPathAndQueryString( '/help/faq/' ); // '/help/faq'
 * ```
 *
 ...
 * const fragment2 = getFragment( '#another-fragment?query=true' ); // '#another-fragment'
 * ```
 *
 ...
 * @example
 * ```js
 * const foo = getQueryArgs( '?foo=bar&bar=baz' );
 * // { "foo": "bar", "bar": "baz" }
 * ```
 *
 ...
 * @example
 * ```js
 * const foo = getQueryArg( '?foo=bar&bar=baz', 'foo' ); // bar
 * ```
 *
 ...
 * @example
 * ```js
 * const hasBar = hasQueryArg( '?foo=bar&bar=baz', 'bar' ); // true
 * ```
 *
 ...
 * @example
 * ```js
 * const newUrl = removeQueryArgs( '?foo=bar&bar=baz&baz=foobar', 'foo', 'bar' ); // ?baz=foobar
 * ```
 *
