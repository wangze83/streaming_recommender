...
// See https://github.com//gutenberg/pull/40025#discussion_r865410589 for more context.
 ...
 *
 * See https://github.com//gutenberg/pull/41578 for more details.
 */
 ...
 *
 * @see GetEntityRecord
 * @see https://github.com//gutenberg/pull/41578
 */
...
const {
  lock,
  unlock
} = (0,external_wp_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next  release.', '@wordpress/core-data');
...
function useEntityBlockEditor(kind, name, {
  ...
  const updateFootnotes = (0,external_wp_element_namespaceObject.useCallback)(_blocks => {
    ...
    // https://github.com//gutenberg/pull/43204 lands. We can then
 ...
 *
 * @since 6.1.0 Introduced in  core.
 * @private
 *
