...
const VIEW_AS_LINK_SELECTOR = '#sr-admin-bar-view a';
/**
...
const VIEW_AS_PREVIEW_LINK_SELECTOR = '#sr-admin-bar-preview a';
...
const {
  lock,
  unlock
} = (0,external_wp_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next  release.', '@wordpress/edit-post');
...
function PostPublishButtonOrToggle({
   ...
   * for a particular role (see /documentation/article/post-status/):
   *
   * - is published
