 ...
 * @param string|false     $src       Full URL of the script, or path of the script relative to the  root directory.
...
function wp_deregister_script( $handle ) {
	...
	if ( ( is_admin() && 'admin_enqueue_scripts' !== $current_filter ) ||
		( 'sr-login.php' === $pagenow && 'login_enqueue_scripts' !== $current_filter )
	) {
		$not_allowed = array(
			'jquery',
			'jquery-core',
