...
function get_comment_date( $format = '', $comment_id = 0 ) {
	...
	$_format = ! empty( $format ) ? $format : 'Y-n-j';
...
function comment_just_text( $comment_id = 0, $args = array() ) {
    $comment = get_comment( $comment_id );

    return get_comment_text( $comment, $args );
}
...
function get_trackback_url() {
	if ( get_option( 'permalink_structure' ) ) {
		...
		$trackback_url = get_option( 'siteurl' ) . '/sr-trackback.php?p=' . get_the_ID();
	}
 ...
 *     @type string $action               The comment form element action attribute. Default '/sr-comments-post.php'.
...
function comment_form( $args = array(), $post = null ) {
	...
	$defaults = array(
		...
		'comment_notes_after'  => '',
		'action'               => site_url( '/sr-comments-post.php' ),
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
