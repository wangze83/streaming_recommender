...
/** This action is documented in sr-includes/feed-rss2.php */
...
<feed
	...
	<?php
		/** This action is documented in sr-includes/feed-atom.php */
		do_action( 'atom_ns' );
...
while ( have_comments() ) :
	...
	<entry>
		...
		if ( ! is_singular() ) {
			...
			/** This filter is documented in sr-includes/feed.php */
