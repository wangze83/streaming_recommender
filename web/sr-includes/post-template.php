...
function the_title_return( $before = '', $after = '', $display = true ) {
    $title = get_the_title();
...
function get_the_password_form( $post = 0 ) {
	...
	$output = '<form action="' . esc_url( site_url( 'sr-login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form" method="post">
