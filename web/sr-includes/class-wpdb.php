 ...
 * By default,  uses this class to instantiate the global $wpdb object, providing
...
class wpdb {
	...
	/**
	 * List of deprecated  Multisite global tables.
	 *
	 * @since 6.1.0
	 *
	 * @see wpdb::tables()
	 ...
	 * introduce feature support at a different time to .
	 *
	 * @since 2.7.0
	...
	public function has_cap( $db_cap ) {
		...
		switch ( strtolower( $db_cap ) ) {
			...
			case 'identifier_placeholders': // @since 6.2.0
				/*
				 * As of  6.2, wpdb::prepare() supports identifiers via '%i',
