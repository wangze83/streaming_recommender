...
class wp_xmlrpc_server extends IXR_Server {
	 ...
	 *
	 * Determines whether the xmlrpc server is enabled on this  install
	...
	/**
	 * Converts a  date string to an IXR_Date object.
	 *
	...
	/**
	 * Converts a  GMT date string to an IXR_Date object.
	 *
	...
	public function wp_newPost( $args ) {
		...
		/** This action is documented in sr-includes/class-wp-xmlrpc-server.php */
	...
	public function pingback_ping( $args ) {
		...
		/** This filter is documented in sr-includes/class-wp-http.php */
