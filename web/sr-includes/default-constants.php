...
function wp_initial_constants() {
	 ...
	 * to signify development mode for  core, a plugin, a theme, or all three types respectively.
	 */
...
function wp_cookie_constants() {
	...
	if ( ! defined( 'AUTH_COOKIE' ) ) {
		define( 'AUTH_COOKIE', 'thewzsr_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'SECURE_AUTH_COOKIE' ) ) {
		define( 'SECURE_AUTH_COOKIE', 'thewzsr_sec_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'LOGGED_IN_COOKIE' ) ) {
		define( 'LOGGED_IN_COOKIE', 'thewzsr_logged_in_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'TEST_COOKIE' ) ) {
		define( 'TEST_COOKIE', 'thewzsr_test_cookie' );
	}
	...
	if ( ! defined( 'ADMIN_COOKIE_PATH' ) ) {
		define( 'ADMIN_COOKIE_PATH', SITECOOKIEPATH . 'sr-admin' );
	}
	...
	if ( ! defined( 'RECOVERY_MODE_COOKIE' ) ) {
		 ...
		 * @since 5.2.0
		 */
		define( 'RECOVERY_MODE_COOKIE', 'thewzsr_rec_' . COOKIEHASH );
	}
}
