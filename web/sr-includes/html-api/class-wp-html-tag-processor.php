...
class WP_HTML_Tag_Processor {
	...
	public function set_attribute( $name, $value ) {
		...
		/*
		 *  rejects more characters than are strictly forbidden
		 * in HTML5. This is to prevent additional security risks deeper
		 * in the  and plugin stack. Specifically the
	...
	private function matches() {
		...
		if ( $needs_class_name ) {
			 ...
			 */
			while (
				// phpcs:ignore .CodeAnalysis.AssignmentInCondition.FoundInWhileCondition
