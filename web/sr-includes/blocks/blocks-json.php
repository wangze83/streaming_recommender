<?php return array(
  ...
  'comment-edit-link' => array(
    ...
    'description' => 'Displays a link to edit the comment in the  Dashboard. This link is only visible to users with the edit comment capability.',
    'textdomain' => 'default',
    'usesContext' => array(
      'commentId'
    ),
  ...
  'freeform' => array(
    ...
    'title' => 'Classic',
    'category' => 'text',
    'description' => 'Use the classic  editor.',
    'textdomain' => 'default',
    'attributes' => array(
      'content' => array(
        'type' => 'string',
  ...
  'shortcode' => array(
    ...
    'title' => 'Shortcode',
    'category' => 'widgets',
    'description' => 'Insert additional custom elements with a  shortcode.',
    'textdomain' => 'default',
    'attributes' => array(
      'text' => array(
        'type' => 'string',
