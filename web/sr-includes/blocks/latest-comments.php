 ...
 * returned.
 *
 * Copied from `sr-admin/includes/template.php`, but we can't include that
 * file because:
 *
...
function render_block_core_latest_comments( $attributes = array() ) {
	$comments = get_comments(
		/** This filter is documented in sr-includes/widgets/class-wp-widget-recent-comments.php */
		apply_filters(
