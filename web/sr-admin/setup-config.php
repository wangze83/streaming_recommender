...
require ABSPATH . 'sr-settings.php';
...
if ( @file_exists( ABSPATH . '../wp-config.php' ) && ! @file_exists( ABSPATH . '../sr-settings.php' ) ) {
	wp_die();
}
...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<p id="dbname-desc"><?php _e( 'The name of the database you want to use with .' ); ?></p></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<p id="prefix-desc"><?php _e( 'If you want to run multiple  installations in a single database, change this.' ); ?></p></td>
		</tr>
	</table>
		<?php
		if ( isset( $_GET['noapi'] ) ) {
