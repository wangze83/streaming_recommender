...
if ( 'grid' === $mode ) {
	...
	// Remove the error parameter added by deprecation of sr-admin/media.php.
	add_filter(
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/media-library-screen/">Documentation on Media Library</a>' ) . '</p>' .
