...
if ( isset( $_GET['action'] ) ) {
	...
	if ( 'update-selected' === $action ) {
		...
		require_once ABSPATH . 'sr-admin/includes/plugin-install.php'; // For plugins_api().
		...
		require_once ABSPATH . 'sr-admin/includes/class-wp-upgrader.php'; // For themes_api().
		 ...
		 * provided in the request for sr-admin/update.php. Can be used to
