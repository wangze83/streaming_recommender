...
function core_upgrade_preamble() {
	...
	if ( isset( $updates[0]->version ) && version_compare( $updates[0]->version, $wp_version, '>' ) ) {
		...
		printf(
			...
			__( '/documentation/article/wordpress-backups/' ),
			__( '/documentation/article/updating-wordpress/' )
		);
		echo '</p></div>';
...
function core_auto_updates_settings() {
	...
	/** This filter is documented in sr-admin/includes/class-core-upgrader.php */
...
if ( ( current_user_can( 'update_themes' ) && wp_is_auto_update_enabled_for_type( 'theme' ) ) || ( current_user_can( 'update_plugins' ) && wp_is_auto_update_enabled_for_type( 'plugin' ) ) ) {
	...
	$help_sidebar_autoupdates = '<p>' . __( '<a href="/documentation/article/plugins-themes-auto-updates/">Documentation on Auto-updates</a>' ) . '</p>';
}
...
if ( current_user_can( 'update_themes' ) || current_user_can( 'update_plugins' ) ) {
	...
	$help_sidebar_rollback = '<p>' . __( '<a href="/documentation/article/common-wordpress-errors/">Common Errors</a>' ) . '</p>';
}

get_current_screen()->set_help_sidebar(
	'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
	'<p>' . __( '<a href="/documentation/article/dashboard-updates-screen/">Documentation on Updating </a>' ) . '</p>' .
	$help_sidebar_autoupdates .
