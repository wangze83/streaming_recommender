...
if ( $action ) {
	...
	switch ( $action ) {
		...
		case 'error_scrape':
			...
			/** This action is documented in sr-admin/includes/plugin.php */
		...
		case 'delete-selected':
			...
			require ABSPATH . 'sr-admin/update.php';
		...
		default:
			if ( isset( $_POST['checked'] ) ) {
				...
				/** This action is documented in sr-admin/edit.php */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/manage-plugins/">Documentation on Managing Plugins</a>' ) . '</p>' .
	$help_sidebar_autoupdates .
