	...
	<div class="wrap about__container">
				...
				<p>
					...
					printf(
						...
						sprintf(
							...
							esc_url( __( '/support/wordpress-version/version-%s/' ) ),
		...
		<div class="about__section aligncenter">
			<div class="column">
				...
				<p class="is-subheading">
					<?php _e( 'Create beautiful and compelling websites more efficiently than ever. Whether you want to build an entire site without coding or are a developer looking to customize every detail,  6.3 has something for you.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			...
			<div class="column is-vertically-aligned-center">
				...
				<p><?php _e( ' 6.3 brings your content, templates, and patterns together in the Site Editor for the first time. Add pages, browse style variations, create synced patterns, and enjoy fine-tuned control over your navigation menus. No more time wasted switching across different site areas—now you can focus on what matters most. Creation to completion, all in one place.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p><?php _e( ' 6.3 has 170+ performance updates, including defer and async support for the Scripts API and fetchpriority support for images. These improvements can improve your website&#8217;s load time as perceived by visitors, along with block template resolution, image lazy-loading, and the emoji loader.' ); ?></p>
			</div>
			<div class="column">
				<div class="about__image">
					<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
		...
		<div class="about__section has-3-columns">
			...
			<div class="column is-vertically-aligned-center" style="grid-column-end:span 2">
				...
				<p>
					<?php
					printf(
						/* translators: 1: Learn  link, 2: Workshops link. */
						__( '<a href="%1$s">Learn </a> is a free resource for new and experienced  users. Learn is stocked with how-to videos on using various features in , <a href="%2$s">interactive events</a> for exploring topics in-depth, and lesson plans for diving deep into specific areas of .' ),
						'/',
						'/'
					);
					?>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
					printf(
						/* translators: %s:  Field Guide link. */
			...
			<div class="column">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
					printf(
						/* translators: 1:  Release Notes link, 2:  version number. */
						__( '<a href="%1$s">Read the  %2$s Release Notes</a> for more information on the included enhancements and issues fixed, installation information, developer notes and resources, release contributors, and the list of file changes in this release.' ),
						sprintf(
							/* translators: %s:  version number. */
							esc_url( __( '/documentation/wordpress-version/version-%s/' ) ),
							'6-3'
						),
						'6.3'
					);
...
<?php require_once ABSPATH . 'sr-admin/admin-footer.php'; ?>
...
/* translators: 1:  version number, 2: Link to update  */
__( 'Important! Your version of  (%1$s) is no longer supported, you will not receive any security updates for your website. To keep your site secure, please <a href="%2$s">update to the latest version of </a>.' );

/* translators: 1:  version number, 2: Link to update  */
__( 'Important! Your version of  (%1$s) will stop receiving security updates in the near future. To keep your site secure, please <a href="%2$s">update to the latest version of </a>.' );

/* translators: %s: The major version of  for this branch. */
__( 'This is the final release of  %s' );

/* translators: The localized  download URL. */
__( '/download/' );
