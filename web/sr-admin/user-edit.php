...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/users-your-profile-screen/">Documentation on User Profiles</a>' ) . '</p>' .
				...
				<table class="form-table" role="presentation">
					...
					<tr class="user-comment-shortcuts-wrap">
						...
						<td>
							...
							<?php _e( '<a href="/documentation/article/keyboard-shortcuts-classic-editor/#keyboard-shortcuts-for-comments">Documentation on Keyboard Shortcuts</a>' ); ?>
						</td>
					</tr>
					<?php endif; ?>
