...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/site-health-screen/">Documentation on Site Health tool</a>' ) . '</p>'
);
...
<div class="health-check-body health-check-status-tab hide-if-no-js">
	...
	<div class="site-status-has-issues">
		...
		<p><?php _e( 'The site health check shows information about your  configuration and items that may need your attention.' ); ?></p>
