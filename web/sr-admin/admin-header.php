 ...
 * 2. Not all core admin classes are filterable, notably: sr-admin, wp-core-ui,
...
?>
<body class="sr-admin wp-core-ui no-js <?php echo esc_attr( $admin_body_classes ); ?>">
<script type="text/javascript">
...
<div id="wpwrap">
<?php require ABSPATH . 'sr-admin/menu-header.php'; ?>
<div id="wpcontent">
...
if ( 'options-general.php' === $parent_file ) {
	require ABSPATH . 'sr-admin/options-head.php';
}
