 ...
 */
if ( 'upload' !== $tab ) {
	/** This action is documented in sr-admin/plugin-install.php */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/plugins-add-new-screen/">Documentation on Installing Plugins</a>' ) . '</p>' .
