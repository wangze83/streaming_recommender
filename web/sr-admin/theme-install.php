...
require ABSPATH . 'sr-admin/includes/theme-install.php';
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/appearance-themes-screen/#install-themes">Documentation on Adding New Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="/documentation/article/block-themes/">Documentation on Block Themes</a>' ) . '</p>' .
