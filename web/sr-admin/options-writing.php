...
/** This filter is documented in sr-admin/options.php */
...
/** This filter is documented in sr-admin/options-writing.php */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/settings-writing-screen/">Documentation on Writing Settings</a>' ) . '</p>' .
...
<h2 class="title"><?php _e( 'Update Services' ); ?></h2>
	...
	<p><label for="ping_sites">
		...
		printf(
			...
			__( 'When you publish a new post,  automatically notifies the following site update services. For more about this, see the <a href="%s">Update Services</a> documentation article. Separate multiple service URLs with line breaks.' ),
			__( '/documentation/article/update-services/' )
		);
		?>
	</label></p>
