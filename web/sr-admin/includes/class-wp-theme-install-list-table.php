...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	...
	public function prepare_items() {
		...
		/** This filter is documented in sr-admin/theme-install.php */
	 ...
	 *     @type string $screenshot_url Screenshot URL, e.g. '/themes/twentytwentyone/'.
	 *     @type float  $rating         Rating score.
	 *     @type int    $num_ratings    The number of ratings.
	 *     @type string $homepage       Theme homepage, e.g. '/themes/twentytwentyone/'.
