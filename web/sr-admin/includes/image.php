...
function wp_update_image_subsizes( $attachment_id ) {
	...
	/** This filter is documented in sr-admin/includes/image.php */
	...
	if ( is_callable( 'iptcparse' ) ) {
		...
		if ( ! empty( $info['APP13'] ) ) {
			...
			if ( defined( 'WP_DEBUG' ) && WP_DEBUG
				...
				// phpcs:ignore .PHP.NoSilencedErrors -- Silencing notice and warning is intentional. See https://core.trac.wordpress.org/ticket/42480
				$iptc = @iptcparse( $info['APP13'] );
			}
