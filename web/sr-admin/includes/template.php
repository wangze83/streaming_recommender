...
require_once ABSPATH . 'sr-admin/includes/class-walker-category-checklist.php';

/** WP_Internal_Pointers class */
require_once ABSPATH . 'sr-admin/includes/class-wp-internal-pointers.php';
	...
	foreach ( (array) $terms as $term ) {
		...
		<li id="<?php echo $id; ?>" class="popular-category">
			<label class="selectit">
				...
				<?php
				/** This filter is documented in sr-includes/category-template.php */
...
<div class="hidden" id="inline_' . $post->ID . '">
	...
	/** This filter is documented in sr-admin/edit-tag-form.php */
...
var ajaxurl = '<?php echo esc_js( admin_url( 'admin-ajax.php', 'relative' ) ); ?>',
	...
	<?php
	/** This action is documented in sr-admin/admin-header.php */
	...
	/** This filter is documented in sr-admin/admin-header.php */
	$admin_body_classes = apply_filters( 'admin_body_class', '' );
	$admin_body_classes = ltrim( $admin_body_classes . ' ' . $admin_body_class );
	?>
<body <?php echo $admin_body_id; ?>class="sr-admin wp-core-ui no-js iframe <?php echo esc_attr( $admin_body_classes ); ?>">
<script type="text/javascript">
(function(){
...
function iframe_footer() {
	...
	<div class="hidden">
	<?php
	/** This action is documented in sr-admin/admin-footer.php */
