...
<p>
	...
	printf(
		...
		__( '/documentation/article/what-is-an-excerpt-classic-editor/' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		...
		__( '/documentation/article/introduction-to-blogging/#comments' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		...
		__( '/documentation/article/assign-custom-fields/' )
	);
	?>
</p>
	<?php
...
<p class="meta-options">
	...
	<label for="ping_status" class="selectit"><input name="ping_status" type="checkbox" id="ping_status" value="open" <?php checked( $post->ping_status, 'open' ); ?> />
		...
		printf(
			...
			__( '/documentation/article/introduction-to-blogging/#managing-comments' )
		);
		?>
	</label>
	<?php
