...
function wp_ajax_imgedit_preview() {
	...
	require_once ABSPATH . 'sr-admin/includes/image-edit.php';
...
function wp_ajax_autocomplete_user() {
	...
	/** This filter is documented in sr-admin/user-new.php */
...
function wp_ajax_dashboard_widgets() {
	require_once ABSPATH . 'sr-admin/includes/dashboard.php';
...
function wp_ajax_add_tag() {
	...
	require ABSPATH . 'sr-admin/includes/edit-tag-messages.php';
...
function wp_ajax_add_menu_item() {
	...
	require_once ABSPATH . 'sr-admin/includes/nav-menu.php';
	...
	/** This filter is documented in sr-admin/includes/nav-menu.php */
...
function wp_ajax_inline_save() {
	...
	if ( ! empty( $data['tax_input'] ) ) {
		foreach ( $data['tax_input'] as $taxonomy => $terms ) {
			...
			/** This filter is documented in sr-admin/includes/class-wp-posts-list-table.php */
...
function wp_ajax_save_widget() {
	...
	/** This action is documented in sr-admin/widgets.php */
...
function wp_ajax_delete_inactive_widgets() {
	...
	/** This action is documented in sr-admin/includes/ajax-actions.php */
	do_action( 'load-widgets.php' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	/** This action is documented in sr-admin/includes/ajax-actions.php */
	do_action( 'widgets.php' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	/** This action is documented in sr-admin/widgets.php */
...
/**
 * Handles dismissing a  pointer via AJAX.
 *
 * @since 3.1.0
 */
...
function wp_ajax_get_revision_diffs() {
	require ABSPATH . 'sr-admin/includes/revision.php';
...
function wp_ajax_query_themes() {
	...
	/** This filter is documented in sr-admin/includes/class-wp-theme-install-list-table.php */
...
function wp_ajax_crop_image() {
	...
	switch ( $context ) {
		case 'site-icon':
			...
			/** This filter is documented in sr-admin/includes/class-custom-image-header.php */
...
/**
 * Handles saving the user's .org username via AJAX.
 *
 * @since 4.4.0
 */
...
function wp_ajax_install_theme() {
	...
	require_once ABSPATH . 'sr-admin/includes/class-wp-upgrader.php';
...
function wp_ajax_install_plugin() {
	...
	require_once ABSPATH . 'sr-admin/includes/class-wp-upgrader.php';
	require_once ABSPATH . 'sr-admin/includes/plugin-install.php';
...
function wp_ajax_health_check_dotorg_communication() {
	...
	if ( ! class_exists( 'WP_Site_Health' ) ) {
		require_once ABSPATH . 'sr-admin/includes/class-wp-site-health.php';
	}
...
function wp_ajax_health_check_get_sizes() {
	...
	if ( ! class_exists( 'WP_Debug_Data' ) ) {
		require_once ABSPATH . 'sr-admin/includes/class-wp-debug-data.php';
	}
...
function wp_ajax_toggle_auto_updates() {
	...
	switch ( $type ) {
		case 'plugin':
			...
			/** This filter is documented in sr-admin/includes/class-wp-plugins-list-table.php */
