...
function _unzip_file_pclzip( $file, $to, $needed_dirs = array() ) {
	...
	require_once ABSPATH . 'sr-admin/includes/class-pclzip.php';
...
function WP_Filesystem( $args = false, $context = false, $allow_relaxed_file_ownership = false ) { // phpcs:ignore .NamingConventions.ValidFunctionName.FunctionNameInvalid
	...
	require_once ABSPATH . 'sr-admin/includes/class-wp-filesystem-base.php';
	...
	if ( ! class_exists( "WP_Filesystem_$method" ) ) {
		 ...
		 */
		$abstraction_file = apply_filters( 'filesystem_method_file', ABSPATH . 'sr-admin/includes/class-wp-filesystem-' . $method . '.php', $method );
 ...
 *
 * @link /documentation/article/editing-wp-config-php/#wordpress-upgrade-constants
 *
...
function wp_opcache_invalidate_directory( $dir ) {
	...
	if ( ! is_string( $dir ) || '' === trim( $dir ) ) {
		if ( WP_DEBUG ) {
			...
			// phpcs:ignore .PHP.DevelopmentFunctions.error_log_trigger_error
