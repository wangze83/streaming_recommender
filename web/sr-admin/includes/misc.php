...
function wp_admin_canonical_url() {
	...
	?>
	<link id="sr-admin-canonical" rel="canonical" href="<?php echo esc_url( $filtered_url ); ?>" />
	<script>
		if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'sr-admin-canonical' ).href + window.location.hash );
		}
	</script>
	<?php
}
 ...
 *
 *     @type string $recommended_version The PHP version recommended by .
