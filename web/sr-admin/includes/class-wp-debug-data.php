...
class WP_Debug_Data {
	...
	public static function debug_data() {
		...
		$wp_dotorg = wp_remote_get( '', array( 'timeout' => 10 ) );
		...
		if ( $auto_updates_enabled ) {
			...
			/** This filter is documented in sr-admin/includes/class-wp-debug-data.php */
	...
	/**
	 * Fetches the sizes of the  directories: `wordpress` (ABSPATH), `plugins`, `themes`, and `uploads`.
