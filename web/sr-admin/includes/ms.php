...
function wpmu_delete_blog( $blog_id, $drop = false ) {
	...
	if ( $drop ) {
		...
		/** This action is documented in sr-includes/ms-blogs.php */
...
function wpmu_delete_user( $id ) {
	...
	/** This action is documented in sr-admin/includes/user.php */
...
function confirm_delete_users( $users ) {
	...
	<?php
	/** This action is documented in sr-admin/users.php */
...
function get_site_screen_help_sidebar_content() {
	return '<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
		'<p>' . __( '<a href="/documentation/article/network-admin-sites-screen/">Documentation on Site Management</a>' ) . '</p>' .
		'<p>' . __( '<a href="/support/forum/multisite/">Support forums</a>' ) . '</p>';
}
