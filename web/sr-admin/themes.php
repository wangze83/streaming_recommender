...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/work-with-themes/">Documentation on Using Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="/documentation/article/appearance-themes-screen/">Documentation on Managing Themes</a>' ) . '</p>' .
	$help_sidebar_autoupdates .
...
if ( is_array( $submenu ) && isset( $submenu['themes.php'] ) ) {
	...
	foreach ( (array) $submenu['themes.php'] as $item ) {
		...
		if ( ! empty( $submenu[ $item[2] ] ) ) {
			...
			if ( file_exists( ABSPATH . "sr-admin/$menu_file" ) ) {
