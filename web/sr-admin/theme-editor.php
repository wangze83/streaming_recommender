...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="/documentation/article/appearance-theme-file-editor-screen/">Documentation on Editing Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="/documentation/article/editing-files/">Documentation on Editing Files</a>' ) . '</p>' .
...
if ( ! in_array( 'theme_editor_notice', $dismissed_pointers, true ) ) :
	...
	$excluded_referer_basenames = array( 'theme-editor.php', 'sr-login.php' );
