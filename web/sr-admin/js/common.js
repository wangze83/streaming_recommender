...
$( function() {
	...
	function adjustSubmenu( $menuItem ) {
		...
		if ( adjustment > 1 && $('#sr-admin-bar-menu-toggle').is(':hidden') ) {
	...
	window.wpResponsive = {
		...
		init: function() {
			...
			$( '#sr-admin-bar-menu-toggle a' ).attr( 'aria-expanded', 'false' );

			// Toggle sidebar when toggle is clicked.
			$( '#sr-admin-bar-menu-toggle' ).on( 'click.wp-responsive', function( event ) {
				event.preventDefault();
			...
			$( '#sr-admin-bar-menu-toggle, #adminmenumain' ).on( 'focusout', function() {
				...
				setTimeout( function() {
					focusIsInToggle  = $.contains( $( '#sr-admin-bar-menu-toggle' )[0], $( ':focus' )[0] );
					focusIsInSidebar = $.contains( $( '#adminmenumain' )[0], $( ':focus' )[0] );

					if ( ! focusIsInToggle && ! focusIsInSidebar ) {
						$( '#sr-admin-bar-menu-toggle' ).trigger( 'click.wp-responsive' );
					}
				}, 10 );
			} );
